...
import CadastrarPermissoesSeed from './app/permissoes/seeds/cadastrar-permissoes.seed';
...
export default class AppService implements OnApplicationBootstrap {
  ...
  constructor(
    ...
    private readonly cadastrarPermissoesSeed: CadastrarPermissoesSeed,
  ) {}
